        ...
        <AuthBlockContainer
            title={
                <View className="items-center mb-6">
                    <Text className="text-xl font-semibold text-gray-900">Приветствуем в</Text>
                    <Text className="text-sm text-center mt-1 font-bold text-custom-accent uppercase">ИАС «ЦИФРОВОЙ ВОДОКАНАЛ»</Text>
                </View>
            }
            children={
