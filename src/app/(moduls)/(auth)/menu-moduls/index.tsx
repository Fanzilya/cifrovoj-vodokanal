...
const MenuModulsView = observer(() => {
    return (
        <View className="w-full mx-auto bg-white rounded-2xl border border-gray-100 p-5 shadow-md">
            {/* Header */}
            <View className="items-center mb-6">
                <Text className="text-sm text-gray-600 mb-1 uppercase font-medium">Приветствуем в</Text>
                <Text className="text-sm text-center font-bold text-custom-accent uppercase">ИАС «ЦИФРОВОЙ ВОДОКАНАЛ»</Text>
            </View>
